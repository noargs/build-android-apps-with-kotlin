package github.noargs.saverestoreactivitystate
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // handle the `discount button` onClick event
    ...
    companion object {
        ...
        private const val DISCOUNT_CONFIRMATION_MESSAGE = "DISCOUNT_CONFIRMATION MESSAGE"
